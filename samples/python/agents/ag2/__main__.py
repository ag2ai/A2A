    ...
    try:
        ...
        skills = [
            AgentSkill(
                ...
                description=(
                    "Retrieve closed captions/transcripts from YouTube videos"
                ),
        ...
        agent_card = AgentCard(
            ...
            description=(
                "AI agent that can extract closed captions and transcripts "
                "from YouTube videos. This agent provides raw transcription "
